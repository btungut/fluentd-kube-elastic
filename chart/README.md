...
All the fields in the json object are parsed and queryable with terms. This helm chart imports [an index template](https://github.com/btungut/fluentd-kube-elastic/blob/master/chart/files/index-template.json) which is designed for general purposes.  
...
Regarding other options and their default values, please refer to [`values.yaml`](https://github.com/btungut/fluentd-kube-elastic/blob/master/chart/values.yaml)
...
![Parsing both of plain and json logs](https://github.com/btungut/fluentd-kube-elastic/raw/master/.images/multiline-log-parsed.png)
